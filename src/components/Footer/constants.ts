...
export const FOOTER_LINKS: { home: Link[]; app: Link[] } = {
  home: [
    ...
    { text: defineMessage({ message: "Media Kit" }), link: "https://docs.dfx.so", external: true },
...
export const SOCIAL_LINKS: SocialLink[] = [
  ...
  { link: "https://dfxso.substack.com/", name: "Substack", icon: substackIcon },
  { link: "https://github.com/DFX-Protocol", name: "Github", icon: githubIcon },
