...
function MigrationModal(props) {
  ...
  const onClickPrimary = () => {
    ...
    setIsMigrating(true);
    const contract = new ethers.Contract(dfxMigratorAddress, DfxMigrator.abi, signer);
    contract
        ...
        <div className="MigrationModal-info-box">
          <div className="App-info-row">
            ...
            <div className="align-right">
              {baseAmount &&
                `${formatAmount(baseAmount, 18, 4, true)} DFX ($${formatAmount(
                  baseAmountUsd,
                  18 + decimals,
                  2,
                  true
          ...
          {token.bonus > 0 && (
            <div className="App-info-row">
              ...
              <div className="align-right">
                {bonusAmount &&
                  `${formatAmount(bonusAmount, 18, 4, true)} DFX ($${formatAmount(
                    bonusAmountUsd,
                    18 + decimals,
                    2,
                    true
          ...
          {token.bonus > 0 && (
            <div className="App-info-row">
              ...
              <div className="align-right">
                {totalAmount &&
                  `${formatAmount(totalAmount, 18, 4, true)} DFX ($${formatAmount(
                    totalAmountUsd,
                    18 + decimals,
                    2,
                    true
...
export default function Migration() {
  ...
  const { data: migratedAmounts, mutate: updateMigratedAmounts } = useSWR(
    ...
    {
      fetcher: contractFetcher(signer, DfxMigrator, [tokenAddresses]),
    }
  );
