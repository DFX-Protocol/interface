...
function UnstakeModal(props) {
  const { isVisible, setIsVisible, title, maxAmount, value, setValue, signer, stakingTokenSymbol, farmAddress } =
    props;
  ...
  return (
    <div className="Stake Page page-layout">
      ...
      <div className="App-warning Stake-warning">
        <Trans>
          The <Link to="/migrate">DFX migration</Link> is in progress, please migrate your GMT, xGMT, GMT-USDG and
          xGMT-USDG tokens.
          <br />
