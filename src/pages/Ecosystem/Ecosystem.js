...
export default function Ecosystem() {
  const dfxPages = [
    ...
    {
      title: "DFX Announcements",
      link: "https://t.me/GMX_Announcements",
      linkLabel: "t.me",
      about: t`DFX Announcements and Updates`,
      chainIds: [ARBITRUM, AVALANCHE],
    },
  ];
  ...
  const communityProjects = [
    ...
    {
      title: "DFX Positions Bot",
      link: "https://t.me/GMXPositions",
      linkLabel: "t.me",
      about: t`Telegram bot for DFX position updates`,
    ...
    },
    {
      ...
      linkLabel: "t.me",
      about: t`Telegram bot for DFX Swaps monitoring`,
      creatorLabel: "@snipermonke01",
      creatorLink: "https://twitter.com/snipermonke01",
      chainIds: [ARBITRUM, AVALANCHE],
    },
    {
      title: "DFX Position Calculator",
  ...
  const dashboardProjects = [
    {
      title: "DFX Referrals Dashboard",
      link: "https://www.gmxreferrals.com/",
      linkLabel: "gmxreferrals.com",
      about: t`Dashboard for DFX referral stats`,
      creatorLabel: "@kyzoeth",
      creatorLink: "https://twitter.com/kyzoeth",
      chainIds: [ARBITRUM, AVALANCHE],
    },
    {
      ...
      about: t`DFX explorer for stats and traders`,
    ...
    {
      title: "DFX Perpetuals Data",
      link: "https://app.laevitas.ch/altsderivs/DFX/perpetualswaps",
      linkLabel: "laevitas.ch",
      about: t`DFX Perpetuals Data`,
      creatorLabel: "@laevitas1",
      creatorLink: "https://twitter.com/laevitas1",
      chainIds: [ARBITRUM],
    },
    {
      title: "DFX Blueberry Leaderboard",
  ...
  const integrations = [
    ...
    },
    {
      ...
      about: t`DLP autocompounding vaults`,
      ...
      <div className="default-container page-layout">
        <div>
          <div className="section-title-block">
            ...
            <div className="section-title-content">
              <div className="Page-title">
                <Trans>DFX Pages</Trans>
              </div>
              <div className="Page-description">
                <Trans>DFX ecosystem pages.</Trans>
              </div>
            </div>
          </div>
          ...
          <div className="Tab-title-section">
            ...
            <div className="Page-description">
              <Trans>
                Projects developed by the DFX community. <br />
          ...
          <div className="Tab-title-section">
            ...
            <div className="Page-description">
              <Trans>DFX dashboards and analytics.</Trans>
            </div>
          </div>
          <div className="DashboardV2-projects">
          ...
          <div className="Tab-title-section">
            ...
            <div className="Page-description">
              <Trans>Projects integrated with DFX.</Trans>
            </div>
          </div>
          <div className="DashboardV2-projects">
