        ...
        <div className="section-title-block">
          <div className="section-title-content">
            <div className="Page-title">
              <Trans>Buy DFX on {getChainName(chainId)}</Trans>
            </div>
            <div className="Page-description">
              <Trans>Choose to buy from decentralized or centralized exchanges.</Trans>
              <br />
              <Trans>
                To purchase DFX on the {isArbitrum ? "Avalanche" : "Arbitrum"} blockchain, please{" "}
...
function DecentralisedExchanges({ chainId, externalLinks }) {
  const isArbitrum = chainId === ARBITRUM;
  return (
    <Card title={t`Buy DFX from a Decentralized Exchange`}>
      <div className="App-card-content">
        {isArbitrum ? (
        ...
        {isArbitrum && (
          <div className="exchange-info-group">
            ...
            <div className="buttons-group col-1">
              <Button
                variant="clear"
                to={"https://app.bondprotocol.finance/#/issuers/DFX"}
